...
static int ar02_3inch_prepare(struct drm_panel *panel)
{
	...
	dev_err(dev, "ar02_3inch_prepare out\n");
	return 0;
}
...
static const struct of_device_id ar02_3inch_of_match[] = {
	{ .compatible = "ayaneo,ar02-half-fhd" },
	{ /* sentinel */ }
};
...
MODULE_AUTHOR("linux-mdss-dsi-panel-driver-generator <kancy2333@outlook.com>");
MODULE_DESCRIPTION("DRM driver for ar02 3inch video mode dsi panel");
MODULE_LICENSE("GPL");
